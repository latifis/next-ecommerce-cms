...
export default function CategorySearchSort({
    ...
    setSortOrder,
    setPageSize,
}: CategorySearchSortProps) {
    const toggleSortOrder = (field: keyof Category) => {
        if (sortField === field) {
        ...
        <div className="bg-white rounded-lg p-6 shadow-md flex flex-wrap gap-4 items-center border border-gray-200">
            ...
            <div className="flex items-center gap-4">
                ...
                {CATEGORY_SORT_FIELDS.map((field) => (
                    <button
                        key={field}
                        onClick={() => toggleSortOrder(field as keyof Category)}
